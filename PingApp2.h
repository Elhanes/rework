...
#ifndef __INET_PINGAPP2_H
#define __INET_PINGAPP2_H
 ...
 */
class INET_API PingApp2 : public cSimpleModule, public ILifecycle
{
  protected:
    ...
    std::pair<std::string,double> pinginfo;
  ...
  public:
    ...
    virtual std::pair<std::string,double> getpinginfo();
};
